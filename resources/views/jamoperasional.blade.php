...
<body class="main-bg-pattern text-slate-900 antialiased overflow-x-hidden">
    ...
    <main class="container mx-auto px-6 py-32 relative">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-40 max-w-7xl mx-auto">
            {{-- OPENING CARD --}}
            <div class="blue-gradient-card p-12 md:p-16 rounded-[4rem] text-white relative overflow-hidden shadow-2xl hover-card group" data-aos="fade-up">
                <i class="fas fa-door-open absolute -bottom-10 -right-10 text-[20rem] opacity-5 transition-transform duration-700 group-hover:scale-110"></i>
                <div class="relative z-10">
                    ...
                    <div class="bg-white/5 backdrop-blur-md border border-white/10 p-10 rounded-[2.5rem] inline-block">
                        ...
                        <div class="flex items-baseline gap-4">
                            <span class="text-7xl font-black tracking-tighter">{{ __('messages.hours.opening.time') }}</span>
            ...
            {{-- CLOSING CARD --}}
            <div class="bg-white p-12 md:p-16 rounded-[4rem] shadow-xl border border-slate-100 relative overflow-hidden hover-card group" data-aos="fade-up" data-aos-delay="200">
                <div class="relative z-10">
                    ...
                    <div class="bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100">
                        ...
                        <p class="mt-6 text-sm text-slate-400 font-semibold leading-relaxed max-w-sm">
                            <i class="fas fa-info-circle mr-2 text-blue-500"></i> {{ __('messages.hours.closing.note') }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-40">
            <div class="text-center mb-24" data-aos="zoom-in">
                <h4 class="font-black uppercase tracking-[0.5em] text-blue-600 text-xs mb-4">{{ __('messages.hours.info.kicker') }}</h4>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl mx-auto">
                {{-- Card Check-in --}}
                <div class="p-12 bg-white rounded-[3.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 hover-card group" data-aos="fade-up" data-aos-delay="100">
                    <div class="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center mb-8 group-hover:bg-blue-600 transition-all duration-500">
                        <i class="fas fa-check-double text-3xl text-blue-600 group-hover:text-white transition-colors"></i>
                    </div>
                    <h5 class="text-sm font-black uppercase text-slate-900 mb-4 tracking-wider">{{ __('messages.hours.cards.checkin.title') }}</h5>
                    <p class="text-sm text-slate-500 leading-relaxed font-medium">{{ __('messages.hours.cards.checkin.desc') }}</p>
                </div>

                {{-- Card Security --}}
                <div class="p-12 bg-white rounded-[3.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 hover-card group" data-aos="fade-up" data-aos-delay="200">
                    <div class="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center mb-8 group-hover:bg-blue-600 transition-all duration-500">
                        <i class="fas fa-shield-alt text-3xl text-blue-600 group-hover:text-white transition-colors"></i>
                    </div>
                    <h5 class="text-sm font-black uppercase text-slate-900 mb-4 tracking-wider">{{ __('messages.hours.cards.security.title') }}</h5>
                    <p class="text-sm text-slate-500 leading-relaxed font-medium">{{ __('messages.hours.cards.security.desc') }}</p>
                </div>

                {{-- Card Info --}}
                <div class="p-12 bg-white rounded-[3.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 hover-card group" data-aos="fade-up" data-aos-delay="300">
                    <div class="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center mb-8 group-hover:bg-blue-600 transition-all duration-500">
                        <i class="fas fa-headset text-3xl text-blue-600 group-hover:text-white transition-colors"></i>
                    </div>
                    <h5 class="text-sm font-black uppercase text-slate-900 mb-4 tracking-wider">{{ __('messages.hours.cards.info.title') }}</h5>
                    <p class="text-sm text-slate-500 leading-relaxed font-medium">{{ __('messages.hours.cards.info.desc') }}</p>
                </div>
            </div>
        </div>

        {{-- NOTICE SECTION --}}
        <section class="max-w-7xl mx-auto bg-blue-700 rounded-[5rem] p-12 md:p-24 text-white shadow-3xl relative overflow-hidden" data-aos="zoom-in">
