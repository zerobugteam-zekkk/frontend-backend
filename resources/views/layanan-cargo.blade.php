    ...
    <header class="relative min-h-[90vh] flex flex-col justify-center bg-slate-950 overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('images/Bandara Malang Abdurachman Saleh.jpg') }}"
                class="absolute inset-0 w-full h-full object-cover opacity-30 scale-105" alt="Background Cargo">
        ...
        <div class="container mx-auto px-6 relative z-10 pt-20">
            <div class="max-w-4xl" data-aos="fade-right">
                ...
                <h1 class="text-6xl md:text-8xl font-black text-white leading-[0.85] uppercase tracking-tighter mb-12">
                    ...
                    <span
                        class="text-transparent border-y border-slate-800 bg-clip-text bg-gradient-to-r from-blue-400 via-white to-slate-400 pt-4 pb-4 inline-block">
    ...
    <main class="container mx-auto px-6 py-32 relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-40 max-w-7xl mx-auto">
            ...
            @foreach ($services as $index => $svc)
                <div class="service-card bg-white p-12 rounded-[3.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 group"
                    data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                    <div
                        class="w-20 h-20 bg-{{ $svc['color'] }}-50 rounded-3xl flex items-center justify-center mb-10 group-hover:bg-{{ $svc['color'] }}-600 transition-all duration-500 shadow-inner">
                        <i
                            class="fas {{ $svc['icon'] }} text-{{ $svc['color'] }}-600 group-hover:text-white text-3xl transition-colors"></i>
                    </div>
        ...
        {{-- OPERATIONAL & CONTACT --}}
        <div class="cargo-dark-gradient rounded-[5rem] p-12 md:p-24 text-white relative overflow-hidden shadow-3xl max-w-7xl mx-auto mb-40"
            data-aos="zoom-in">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center relative z-10">
                <div>
                    <h3
                        class="text-4xl md:text-5xl font-black uppercase italic mb-14 border-l-8 border-blue-500 pl-10 tracking-tighter leading-tight">
                    ...
                    <div class="space-y-12">
                        <div class="flex items-center gap-8 group">
                            <div
                                class="w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center border border-white/10 group-hover:bg-blue-600/20 transition-colors">
                                <i class="fas fa-clock text-blue-400 text-2xl"></i>
                            </div>
                            <div>
                                <p class="font-black uppercase text-[10px] tracking-[0.4em] text-slate-500 mb-2">
                                    {{ __('messages.cargo.operational.hours.label') }}</p>
                                <p class="text-2xl font-bold tracking-tight">
                                    {{ __('messages.cargo.operational.hours.value') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-8 group">
                            ...
                            <div>
                                <p class="font-black uppercase text-[10px] tracking-[0.4em] text-slate-500 mb-2">
                                    {{ __('messages.cargo.operational.location.label') }}</p>
                                <p class="text-2xl font-bold tracking-tight">
                                    {{ __('messages.cargo.operational.location.value') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                @foreach ([1, 2, 3] as $step)
                    <div class="relative group h-full" data-aos="fade-up" data-aos-delay="{{ $step * 150 }}">
                        <div
                            class="p-12 bg-white rounded-[3.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 h-full flex flex-col items-center text-center transition-all group-hover:border-blue-200">
                            <div
                                class="w-16 h-16 bg-blue-600 text-white rounded-2xl flex items-center justify-center mb-8 font-black text-xl shadow-lg shadow-blue-200">
                                0{{ $step }}
                            </div>
