...
<body class="main-bg-pattern text-slate-900 antialiased overflow-x-hidden">
    ...
    <header class="relative min-h-[85vh] flex flex-col justify-center bg-slate-950 overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('images/Bandara Malang Abdurachman Saleh.jpg') }}"
                class="absolute inset-0 w-full h-full object-cover opacity-30 scale-105" alt="Background Check-in">
    ...
    <main class="container mx-auto px-6 py-32 relative">
        <div class="grid grid-cols-1 gap-16 max-w-6xl mx-auto mb-40">
            ...
            @foreach ([1, 2, 3] as $step)
                <div class="group relative bg-white rounded-[4rem] p-10 md:p-20 border border-slate-100 shadow-xl shadow-slate-200/40 hover-card overflow-hidden"
                    ...
                    <div
                        class="absolute -right-12 -top-12 text-[20rem] font-black text-slate-50 opacity-50 group-hover:opacity-80 transition-all leading-none z-0">
                        {{ $step }}
                    </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-16 relative z-10">
                        <div class="lg:w-1/3">
                            <div
                                class="inline-flex items-center justify-center w-20 h-20 rounded-[2rem] bg-blue-600 text-white text-3xl font-black mb-10 shadow-2xl shadow-blue-600/30 group-hover:rotate-6 transition-transform">
                                0{{ $step }}
                            </div>
                            <h3
                                class="text-4xl font-black uppercase tracking-tighter text-slate-900 leading-[0.9] italic">
                        ...
                        <div class="lg:w-2/3">
                            ...
                            @if ($step == 2)
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    @foreach ([1, 2] as $card)
                                        <div
                                            class="p-10 bg-slate-50 rounded-[2.5rem] border border-slate-100 group-hover:border-blue-200 transition-all duration-500">
                                            <span
                                                class="block text-blue-600 font-black uppercase text-[10px] tracking-[0.3em] mb-4">
                                                {{ __("messages.checkin.steps.2.card{$card}_label") }}
                                            </span>
                                            <p
                                                class="text-slate-900 font-black uppercase text-xl tracking-tighter leading-tight">
                            ...
                            @if ($step == 3)
                                <div
                                    class="p-10 bg-blue-600 rounded-[3rem] text-white shadow-2xl shadow-blue-600/30 animate-float">
                                    <h4 class="font-black text-sm uppercase tracking-[0.2em] mb-6 flex items-center">
                                        <span
                                            class="w-10 h-10 rounded-2xl bg-white/20 flex items-center justify-center mr-4">
        ...
        <section
            class="max-w-7xl mx-auto bg-slate-950 rounded-[5rem] p-12 md:p-24 text-white overflow-hidden shadow-3xl relative mb-40"
            data-aos="zoom-in">
            ...
            <div class="relative z-10 flex flex-col xl:flex-row items-center justify-between gap-16">
                ...
                <div class="flex flex-col sm:flex-row gap-6 w-full xl:w-auto">
                    <a href="{{ __('messages.checkin.web.airlines.lion_url') }}" target="_blank"
                        ...
                        <i
                            class="fas fa-external-link-alt ml-3 opacity-50 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform"></i>
                    </a>
        ...
        <div class="max-w-5xl mx-auto mb-20">
            ...
            <div class="grid grid-cols-1 gap-6">
                @foreach (['q1' => 'a1', 'q2' => 'a2'] as $q => $a)
                    <div class="bg-white border border-slate-100 p-10 md:p-14 rounded-[3.5rem] hover-card shadow-xl shadow-slate-200/30"
                        data-aos="fade-up">
                        <div class="flex gap-6">
                            <div
                                class="shrink-0 w-12 h-12 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center font-black text-sm">
                                Q</div>
                            <div>
                                <p
                                    class="font-black text-slate-900 uppercase text-lg mb-6 tracking-tighter leading-tight">
                                    {{ __("messages.checkin.faq.$q") }}
                                </p>
                                <p
                                    class="text-slate-500 font-medium text-lg leading-relaxed border-l-2 border-slate-100 pl-6">
    ...
    <footer class="py-24 border-t border-slate-100 bg-white text-center">
        <div class="container mx-auto px-6">
            <img src="{{ asset('images/dishupmalang.jpg') }}" class="h-12 mx-auto mb-12 opacity-30 grayscale"
                alt="Dishub">
