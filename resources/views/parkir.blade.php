...
<body class="antialiased text-slate-900 overflow-x-hidden">
    ...
    <header class="relative min-h-[70vh] md:min-h-[80vh] flex flex-col justify-center bg-slate-950 overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('images/Bandara Malang Abdurachman Saleh.jpg') }}"
                class="absolute inset-0 w-full h-full object-cover opacity-40 scale-105" alt="Latar Belakang Fasilitas">
    ...
    <main class="container mx-auto px-6 -mt-16 relative z-20 pb-24">
        <div class="max-w-6xl mx-auto">
            ...
            {{-- PARKING --}}
            <div class="bg-white rounded-[3rem] shadow-2xl shadow-blue-900/5 border border-slate-100 overflow-hidden mb-20"
                data-aos="fade-up">
                <div class="p-10 md:p-16 border-b border-slate-50">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                        ...
                        <span
                            class="bg-slate-900 text-white text-[9px] font-black px-4 py-2 rounded-full uppercase tracking-widest self-start md:self-center">
                            ...
                            <tbody class="text-slate-600 text-[13px]">
                                <tr class="hover:bg-white transition-all">
                                    ...
                                    <td class="font-bold text-blue-600">
                                        {{ __('messages.facilities.parking.price_motor_overnight') }}</td>
                                </tr>
                                ...
                                <tr class="hover:bg-white transition-all">
                                    ...
                                    <td class="font-bold text-blue-600">
                                        {{ __('messages.facilities.parking.price_mobil_overnight') }}</td>
                                </tr>
                                ...
                                <tr class="hover:bg-white transition-all">
                                    ...
                                    <td class="font-bold text-blue-600">
                                        {{ __('messages.facilities.parking.price_bus_overnight') }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-20">
                <div class="bg-white p-12 rounded-[3rem] shadow-xl shadow-blue-900/5 border border-slate-100 facility-card transition-all duration-500"
                    data-aos="fade-up">
                ...
                <div class="bg-white p-12 rounded-[3rem] shadow-xl shadow-blue-900/5 border border-slate-100 facility-card transition-all duration-500"
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                            {{-- <i class="fas fa-taxi text-blue-600 mt-1"></i> --}}
                            <p class="text-[12px] font-medium text-slate-700">
                                {!! __('messages.facilities.terminal.arr_li3') !!}
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                <div data-aos="fade-right">
                    ...
                    <div class="space-y-5">
                        <details
                            class="group bg-white rounded-2xl p-6 border border-slate-100 cursor-pointer transition-all hover:border-blue-600 shadow-sm">
                            <summary class="font-bold text-sm uppercase flex justify-between items-center list-none">
                                ...
                                <i
                                    class="fas fa-chevron-down text-[10px] group-open:rotate-180 transition duration-300"></i>
                            </summary>
                        ...
                        <details
                            class="group bg-white rounded-2xl p-6 border border-slate-100 cursor-pointer transition-all hover:border-blue-600 shadow-sm">
                            <summary class="font-bold text-sm uppercase flex justify-between items-center list-none">
                                {{ __('messages.facilities.inclusive.disability_title') }}
                                <i
                                    class="fas fa-chevron-down text-[10px] group-open:rotate-180 transition duration-300"></i>
                            </summary>
                            <p class="text-[12px] text-slate-500 mt-4 leading-relaxed border-t pt-4">
                                {{ __('messages.facilities.inclusive.disability_desc') }}
                            </p>
                        </details>
                ...
                <div class="bg-gradient-to-br from-blue-600 to-blue-800 rounded-[3rem] p-12 text-white relative overflow-hidden shadow-2xl"
                    data-aos="fade-left">
