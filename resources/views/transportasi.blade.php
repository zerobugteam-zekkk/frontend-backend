        ...
        <div class="container mx-auto px-6 py-5 flex items-center justify-between">
            <a href="/" class="group flex items-center space-x-4">
                ...
                <div class="flex flex-col border-l border-white/20 pl-4">
                    ...
                    {{ __('messages.brand.abdurachman') }} <span class="text-blue-500">{{ __('messages.brand.saleh') }}</span></span>
                </div>
            </a>
            <div class="hidden lg:flex items-center space-x-8 text-[11px] font-bold uppercase tracking-widest">
                <span class="text-blue-500 flex items-center"><span class="relative flex h-2 w-2 mr-3"><span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span><span class="relative inline-flex rounded-full h-2 w-2 bg-blue-500"></span></span>
                {{ __('messages.transport.nav.status_label') }}: {{ __('messages.transport.nav.status_value') }}</span>
            </div>
        </div>
    </nav>
    ...
    <header class="relative bg-slate-950 py-32 lg:py-48 overflow-hidden flex items-center justify-center min-h-[95vh]">
        ...
        <div class="relative z-10 container mx-auto px-6 text-center" data-aos="zoom-out">
            ...
            <h1 class="text-5xl md:text-8xl font-black text-white tracking-tighter uppercase leading-[0.9] mb-8">
                ...
                <span class="text-blue-600">{{ __('messages.transport.hero.title_2') }}</span>
            </h1>
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="#layanan" class="px-8 py-4 bg-blue-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-blue-700 transition-all">
                    {{ __('messages.transport.hero.cta_explore') }}</a>
                <a href="#prosedur" class="px-8 py-4 bg-transparent border border-white/20 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-white/10 transition-all">
                    {{ __('messages.transport.hero.cta_security') }}</a>
            </div>
        </div>

        <div class="absolute bottom-10 left-1/2 -translate-x-1/2 text-white/30 flex flex-col items-center animate-bounce-slow">
            <span class="text-[9px] font-black uppercase tracking-[0.3em] mb-2">{{ __('messages.transport.hero.scroll') }}</span>
    ...
    <main id="layanan" class="container mx-auto px-6 -mt-20 relative z-20 pb-32">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
            ...
            {{-- <div class="bg-white rounded-[2.5rem] premium-card overflow-hidden flex flex-col" data-aos="fade-up" data-aos-delay="100">
                ...
                {{-- <div class="p-10 flex-grow">
                    ...
                    <ul class="space-y-5 text-[13px] text-slate-700 font-bold">
                        <li class="flex items-center space-x-4"><i class="fas fa-history text-blue-600 text-lg"></i> <span>{{ __('messages.transport.cards.damri_li_1') }}</span></li>
            ...
            <div class="bg-white rounded-[2.5rem] premium-card overflow-hidden flex flex-col" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="p-10 flex-grow">
                    <h3 class="text-2xl font-black text-slate-900 uppercase tracking-tighter mb-4">{{ __('messages.transport.cards.taxi_title') }}</h3>
                    <p class="text-slate-500 text-sm mb-8 leading-relaxed font-medium">{{ __('messages.transport.cards.taxi_desc') }}</p>
                    <ul class="space-y-5 text-[13px] text-slate-700 font-bold">
                        <li class="flex items-center space-x-4"><i class="fas fa-tags text-blue-600 text-lg"></i> <span>{{ __('messages.transport.cards.taxi_li_1') }}</span></li>
                        <li class="flex items-center space-x-4"><i class="fas fa-user-shield text-blue-600 text-lg"></i> <span>{{ __('messages.transport.cards.taxi_li_2') }}</span></li>
                        <li class="flex items-center space-x-4"><i class="fas fa-clock text-blue-600 text-lg"></i> <span>{{ __('messages.transport.cards.taxi_li_3') }}</span></li>
                    </ul>
                </div>
                <div class="p-8 pt-0">
                    <button class="w-full py-5 border-2 border-slate-900 text-slate-900 rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] hover:bg-slate-900 hover:text-white transition-all">
            ...
            <div class="bg-white rounded-[2.5rem] premium-card overflow-hidden flex flex-col" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="p-10 flex-grow">
                    <h3 class="text-2xl font-black text-slate-900 uppercase tracking-tighter mb-4">
                    ...
                    <ul class="space-y-5 text-[13px] text-slate-700 font-bold">
                        <li class="flex items-center space-x-4"><i class="fas fa-walking text-blue-600 text-lg"></i> <span>{{ __('messages.transport.cards.online_li_1') }}</span></li>
                        <li class="flex items-center space-x-4"><i class="fas fa-info-circle text-blue-600 text-lg"></i> <span>{{ __('messages.transport.cards.online_li_2') }}</span></li>
                        <li class="flex items-center space-x-4"><i class="fas fa-map-pin text-blue-600 text-lg"></i> <span>{{ __('messages.transport.cards.online_li_3') }}</span></li>
                    </ul>
                </div>
                <div class="p-8 pt-0">
                    <a href="#" class="block w-full py-5 bg-slate-100 text-slate-600 text-center rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] hover:bg-slate-200 transition-all">
                ...
                <div class="p-12 lg:p-24 lg:w-2/3">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        <div class="bg-white/5 border border-white/10 p-10 rounded-[2rem] backdrop-blur-md" data-aos="flip-left" data-aos-delay="300">
                            ...
                            <p class="text-4xl font-black text-white">IDR 20.000 <span class="text-xs text-slate-500 uppercase tracking-[0.2em] ml-2">
                        ...
                        <div class="bg-white/5 border border-white/10 p-10 rounded-[2rem] backdrop-blur-md" data-aos="flip-left" data-aos-delay="500">
                            ...
                            <p class="text-4xl font-black text-white">IDR 50.000 <span class="text-xs text-slate-500 uppercase tracking-[0.2em] ml-2">
                                {{ __('messages.transport.parking.per_day') }}</span></p>
                        </div>
                    </div>
                </div>
