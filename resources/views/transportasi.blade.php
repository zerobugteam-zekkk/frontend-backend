...
<main id="layanan" class="container mx-auto px-6 -mt-24 relative z-20 pb-32">
    <div class="flex justify-center">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-5xl">
            ...
            <div class="bg-white rounded-[1.5rem] border border-slate-100 shadow-2xl shadow-slate-200/60 overflow-hidden flex flex-col transition-all duration-500 hover:-translate-y-3 hover:shadow-blue-500/10 group" data-aos="fade-up" data-aos-delay="200">
                <div class="p-10 bg-slate-50/50 border-b border-slate-100 flex justify-center items-center">
                    <div class="w-20 h-20 bg-slate-900 rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-500 animate-float">
                ...
                <div class="p-10 flex-grow flex flex-col items-center text-center">
                    ...
                    <ul class="space-y-4 text-left w-full mb-8 border-t border-slate-50 pt-8">
                        <li class="flex items-center space-x-4">
                            ...
                            <span class="text-[13px] text-slate-700 font-bold uppercase tracking-wider">{{ __('messages.transport.cards.taxi_li_1') }}</span>
                        </li>
                        <li class="flex items-center space-x-4">
                            <div class="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center">
                                <i class="fas fa-user-shield text-blue-600 text-sm"></i>
                            </div>
                            <span class="text-[13px] text-slate-700 font-bold uppercase tracking-wider">{{ __('messages.transport.cards.taxi_li_2') }}</span>
                        </li>
                    </ul>

                    <div class="mt-auto w-full">
                        <button class="w-full py-5 bg-slate-900 text-white rounded-xl font-black text-[11px] uppercase tracking-[0.2em] hover:bg-blue-600 transition-all duration-300 shadow-lg shadow-slate-900/20">
            ...
            <div class="bg-white rounded-[1.5rem] border border-slate-100 shadow-2xl shadow-slate-200/60 overflow-hidden flex flex-col transition-all duration-500 hover:-translate-y-3 hover:shadow-blue-500/10 group" data-aos="fade-up" data-aos-delay="400">
                <div class="p-10 bg-blue-50/30 border-b border-blue-50 flex justify-center items-center">
                    <div class="w-20 h-20 bg-blue-600 rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-500 animate-float" style="animation-delay: 1s">
                ...
                <div class="p-10 flex-grow flex flex-col items-center text-center">
                    ...
                    <ul class="space-y-4 text-left w-full mb-8 border-t border-slate-50 pt-8">
                        <li class="flex items-center space-x-4">
                            ...
                            <span class="text-[13px] text-slate-700 font-bold uppercase tracking-wider">{{ __('messages.transport.cards.online_li_1') }}</span>
                        </li>
                        <li class="flex items-center space-x-4">
                            <div class="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center">
                                <i class="fas fa-map-pin text-blue-600 text-sm"></i>
                            </div>
                            <span class="text-[13px] text-slate-700 font-bold uppercase tracking-wider">{{ __('messages.transport.cards.online_li_3') }}</span>
                        </li>
                    </ul>

                    <div class="mt-auto w-full">
                        <a href="#" class="block w-full py-5 border-2 border-blue-600 text-blue-600 text-center rounded-xl font-black text-[11px] uppercase tracking-[0.2em] hover:bg-blue-600 hover:text-white transition-all duration-300">
